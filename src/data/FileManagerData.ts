            ...
            children: [
                ...
                { 
                    ...
                    children: [
                        ...
                        { id: 'c-windows-media', name: 'Media', type: 'folder', icon: FolderClosedIcon, modified: '10/05/2003', children: [] },
                        ...
                        // C:\Documents and Settings\Administrator
                        {
                            ...
                            children: [
                                ...
                                // My Music
                                {
                                    ...
                                    modified: '28/04/2003',
                                    children: [
                                        { id: 'mus1', name: 'BeethovenOdeToJoy.mp3', type: 'file', icon: GenericAudio, size: '2,872 KB', modified: '12/05/2026' },
                                        { id: 'mus2', name: 'BeethovenNo9Scherzo.mp3', type: 'file', icon: GenericAudio, size: '591 KB', modified: '12/05/2026' },
                                    ],
                                },
                                // My Videos
                                {
